    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="../../index3.html" class="brand-link">
                ...
                <span class="brand-text"><b>Nama Guru</b></span>
            </a>
            <!-- Sidebar -->
            <div class="sidebar">
                <!-- Sidebar Menu -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <!-- Area untuk memuat konten input_soal.php atau add_soal.php -->
                    <div id="content-area">
                        <?php include('input/input_soal.php'); ?>
                    </div>
                </div>
            </section>
            <!-- /.content -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tambah-soal-btn').click(function(e) {
                ...
                $('#content-area').load('input/add_soal.php');
            });
        });
    </script>
</body>
